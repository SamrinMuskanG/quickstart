...
public class TCountryInfo {
	...
	public String toString() {
		return "TCountryInfo [sisoCode=" + sisoCode + ", sName=" + sName + ", sCapitalCity=" + sCapitalCity
				+ ", sPhoneCode=" + sPhoneCode + ", sContinentCode=" + sContinentCode + ", sCurrencyISOCode="
				+ sCurrencyISOCode + ", sCountryFlag=" + sCountryFlag + ", languages=" + languages + "]";
	}
