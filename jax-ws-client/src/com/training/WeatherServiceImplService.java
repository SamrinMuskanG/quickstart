 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://services.training.com/", wsdlLocation = "http://localhost:9000/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://services.training.com/", "WeatherServiceImplService");
    ...
    public WeatherService getWeatherServiceImplPort() {
        return super.getPort(new QName("http://services.training.com/", "WeatherServiceImplPort"), WeatherService.class);
    }
    ...
    public WeatherService getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.training.com/", "WeatherServiceImplPort"), WeatherService.class, features);
    }
