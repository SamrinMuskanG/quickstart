 ...
 * 
 */
@WebServiceClient(name = "ImageProcessingImplService", targetNamespace = "http://services.training.com/", wsdlLocation = "http://localhost:8888/images?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8888/images?wsdl");
